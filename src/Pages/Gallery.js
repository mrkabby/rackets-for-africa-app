...
const images = [
  { id: 3, src: Image16, alt: "Program Event Image 16" },
  { id: 3, src: Image17, alt: "Program Event Image 17" },
  { id: 3, src: Image18, alt: "Program Event Image 18" },
  { id: 3, src: Image19, alt: "Program Event Image 19" },
  { id: 3, src: Image20, alt: "Program Event Image 20" },
  { id: 3, src: Image21, alt: "Program Event Image 21" },
  { id: 3, src: Image22, alt: "Program Event Image 22" },
  { id: 3, src: Image23, alt: "Program Event Image 23" },
  { id: 3, src: Image24, alt: "Program Event Image 24" },
  { id: 3, src: Image25, alt: "Program Event Image 25" },
  { id: 3, src: Image26, alt: "Program Event Image 26" },
  { id: 3, src: Image27, alt: "Program Event Image 27" },
  { id: 3, src: Image32, alt: "Program Event Image 32" },
