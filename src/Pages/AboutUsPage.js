        ...
        <div className="pt-20 p-8 md:p-12 lg:p-16">
          ...
          <div className="text-center mb-12">
            <p className="text-lg text-muted-foreground max-w-4xl mx-auto leading-relaxed">
              ...
              communities in Africa who do not have access to this basic
              necessity for the sport. Our mission is to help foster a love for
              tennis and other racket sports, and to provide opportunities for
              growth and development through play. Rackets For Africa was
              founded in 2021 with the goal of increasing access to tennis in
              Africa. Our team is comprised of dedicated staff and volunteers
              who are passionate about making a difference in the lives of
              children in Africa
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 ">
            ...
            <div className="bg-black p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed text-white">
                To be the leading provider of accessible tennis equipment to
                young potential tennis players. Empowering the next generation
                of tennis champions among African youth and bridging gaps
                between African youth and accessible tennis equipment in
                creating a sustainable future for them in tennis.
              </p>
            </div>
            ...
            <div className="bg-yellow-200 p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
              ...
              <p className="text-muted-foreground leading-relaxed">
                To provide accessible tennis equipment and training resources to
                young players in Africa with an emphasis on gender equality and
