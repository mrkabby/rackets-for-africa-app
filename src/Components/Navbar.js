...
const NavBar = () => {
  ...
  return (
    <nav className="flex flex-wrap items-center justify-between bg-white px-4 fixed w-full top-0 z-50">
      ...
      {/* Support Us Button on Mobile */}
      <div className="flex md:hidden px-4">
        <a href="/donations">
          <div className="flex items-center h-10 w-30 rounded-md bg-[#e5e834] text-black font-medium px-3 py-1">
            <svg
